...
namespace HiEIS.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<JsonResult> LoginApp(string username, string password)
        {
            ...
            {
                var identity = AuthenticationManager
                    .AuthenticationResponseGrant
                    .Identity as ClaimsIdentity;
                if (identity.IsInRole("Accounting Manager"))
                {
                    var business = new CompanyBusiness();
                    var invoiceBusiness = new InvoiceBusiness();
                    var guid = business.GetCompanyGuid(username);
                    var invoices = invoiceBusiness.GetInvoiceSign(username);
                    if (guid != null)
                    {
                        return Json(new
                        {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            //todo: using below loc for ajax return
            //var result = new Models.ValidationResultModel(ModelState);
